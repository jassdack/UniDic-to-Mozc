...
本プロジェクトは、単なる「Mozcの語彙数増加」を目的としたものではありません。現代の日本語入力における最適な体験を再定義するため、以下の3つの大前提に基づいて構築されており、これらの価値観に共鳴するユーザーを対象としています。
...
### 具体的なユースケース
‐ 企業が従業員に支給貸与するPCにユーザー辞書導入済みのものを使用する。
‐ 個人ユーザーが手軽に語彙拡張を試してみる。
‐ この分野に関心のあるパワーユーザーが、改変した辞書やスクリプトを何らかのパッケージに含有させる。
